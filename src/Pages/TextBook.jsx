...
function TextBook() {
  ...
  return (
    <div className="p-6">
      ...
      <button onClick={() => fetchTextBooks(selectedStandard)}  className='w-[20%] h-10 mt  lg:text-xl md:text-xl sm:text-lg text-lg text-white font-bold  border-2 rounded-md bg-blue-500 border-blue-950 hover:border-black '>Search</button>
      <button  onClick={() => fetchTextBooks('')} className='w-[20%] h-10 mt  lg:text-xl md:text-xl sm:text-lg text-lg text-white font-semibold  border-2 rounded-md bg-blue-500 border-blue-950 hover:border-black '>Remove Filter</button>
      </div>
