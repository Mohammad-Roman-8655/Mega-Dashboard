    ...
    return (
      <div className="p-6">
        ...
        <div className="Subject lg:w-[30%] md:w-[30%] sm:w-[30%] w-[30%]  flex flex-col">
              ...
              <button  onClick={() => {fetchVideoTutorials(selectedStandard,selectedSubject)}} className='w-[20%] h-10 mt  lg:text-xl md:text-xl sm:text-lg text-lg text-white font-bold  border-2 rounded-md bg-blue-500 border-blue-950 hover:border-black '>Search</button>
              <button  onClick={() => {fetchVideoTutorials('','')}} className='w-[20%] h-10 mt  lg:text-xl md:text-xl sm:text-lg text-lg text-white font-bold  border-2 rounded-md bg-blue-500 border-blue-950 hover:border-black '>Remove Filter</button>
